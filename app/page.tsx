      ...
      <section id="home" className="flex justify-center items-center w-full lg:h-screen scroll-mt-24 mt-20 lg:mt-0 lg:py-0">
        <div className="glass-element bg-black/70 p-0 w-[85%] max-w-6xl overflow-hidden lg:overflow-auto lg:max-w-[85%] h-fit flex flex-col gap-x-8 animate-fade-in-up animate-duration-1000 font-mono">
          ...
          <div className="flex flex-col lg:flex-row w-full p-4 sm:p-8 md:p-10 items-center md:items-start gap-6 md:gap-8 animate-fade-in-up animate-duration-600 animate-delay-800">
            <img src="https://avatars.githubusercontent.com/u/107844615?v=4" className="border-2 border-white/20 rounded-2xl w-56 lg:w-64 transition-all duration-400 hover:ring-2 hover:ring-(--accent-gradient-to) hover:shadow-[0px_0px_25px_var(--accent-gradient-to)] hover:border-black" />
      ...
      <section id="projects" className="flex justify-center items-center w-full scroll-mt-24">
        <motion.div className="glass-element w-[85%] flex flex-col gap-y-6"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-10">
            <motion.div className="glass-element flex flex-col lg:flex-row items-center lg:items-stretch gap-6 lg:gap-x-6 border border-white/20 rounded-xl transition-colors duration-400 ring-2 ring-cyan-500 shadow-[0px_0px_20px_rgba(0,184,219,1)] hover:bg-cyan-500/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              <div className="flex flex-col gap-y-3">
                ...
                <div className="flex gap-3 mt-auto flex-col lg:flex-row">
                  ...
                  <Link href="https://github.com/03-JS/LC-VEGA" target="_blank" className="flex gap-x-2 justify-center items-center bg-white/10 hover:bg-white/25 transition-all duration-400 rounded-sm p-2 lg:w-fit border border-white/20 text-sm"><img src="/github-white-icon.webp" className="w-6" />Source code</Link>
                </div>
              </div>
            </motion.div>
            <motion.div className="glass-element flex flex-col lg:flex-row items-center lg:items-stretch gap-6 lg:gap-x-6 border border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-pink-600 shadow-[0px_0px_20px_rgba(230,0,118,1)] hover:bg-pink-600/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              ...
              <div className="flex flex-col gap-y-3">
                ...
                <div className="flex gap-3 mt-auto flex-col lg:flex-row">
                  ...
                  <Link href="https://github.com/03-JS/SpeechRecognitionAPI" target="_blank" className="flex gap-x-2 justify-center items-center bg-white/10 hover:bg-white/25 transition-all duration-400 rounded-sm p-2 lg:w-fit border border-white/20 text-sm"><img src="/github-white-icon.webp" className="w-6" />Source code</Link>
                </div>
              </div>
            </motion.div>
            <motion.div className="glass-element flex flex-col lg:flex-row items-center lg:items-stretch gap-6 lg:gap-x-6 border border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-[#ff0000] shadow-[0px_0px_20px_rgba(255,0,0,1)] hover:bg-[rgba(255,0,0,0.15)]"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              ...
              <div className="flex flex-col gap-y-3">
                ...
                <div className="flex gap-3 mt-auto flex-col lg:flex-row">
                  <Link href="https://gamejolt.com/games/FNaF-Rewired/1014231" target="_blank" className="flex gap-x-2 justify-center items-center bg-[#2F7F6F]/20 hover:bg-[#2F7F6F]/35 transition-all duration-400 rounded-sm p-2 lg:w-fit border border-white/20 text-sm"><img src="/gamejolt_icon.png" className="w-6" />Game Jolt page</Link>
                  <Link href="https://js03.itch.io/fnaf-rewired" target="_blank" className="flex gap-x-2 justify-center items-center bg-[#FA5252]/20 hover:bg-[#FA5252]/35 transition-all duration-400 rounded-sm p-2 lg:w-fit border border-white/20 text-sm"><img src="/itchio_white_icon.webp" className="w-6" />itch.io page</Link>
                </div>
              </div>
            </motion.div>
            <motion.div className="glass-element flex flex-col lg:flex-row items-center lg:items-stretch gap-6 lg:gap-x-6 border border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-amber-500 shadow-[0px_0px_20px_rgba(254,154,0,1)] hover:bg-amber-500/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              ...
              <div className="flex flex-col gap-y-3">
                ...
                <div className="flex gap-3 mt-auto flex-col lg:flex-row">
                  ...
                  <Link href="https://github.com/03-JS/Ultra-Nightmare" target="_blank" className="flex gap-x-2 justify-center items-center bg-white/10 hover:bg-white/25 transition-all duration-400 rounded-sm p-2 lg:w-fit border border-white/20 text-sm"><img src="/github-white-icon.webp" className="w-6" />Source code</Link>
                </div>
              </div>
            </motion.div>
            <motion.div className="glass-element flex flex-col lg:flex-row items-center lg:items-stretch gap-6 lg:gap-x-6 border border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-green-500 shadow-[0px_0px_20px_rgba(0,201,80,1)] hover:bg-green-500/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              ...
              <div className="flex flex-col gap-y-3">
                ...
                <div className="flex gap-3 mt-auto flex-col lg:flex-row">
                  ...
                  <Link href="https://github.com/03-JS/LethalDebt" target="_blank" className="flex gap-x-2 justify-center items-center bg-white/10 hover:bg-white/25 transition-all duration-400 rounded-sm p-2 lg:w-fit border border-white/20 text-sm"><img src="/github-white-icon.webp" className="w-6" />Source code</Link>
                </div>
              </div>
            </motion.div>
            <motion.div className="glass-element flex flex-col lg:flex-row items-center lg:items-stretch gap-6 lg:gap-x-6 border border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-neutral-400 shadow-[0px_0px_20px_rgba(161,161,161,1)] hover:bg-neutral-400/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              ...
              <div className="flex flex-col gap-y-3">
                ...
                <div className="flex gap-3 mt-auto flex-col lg:flex-row">
                  ...
                  <Link href="https://github.com/03-JS/KeepEnemyPower" target="_blank" className="flex gap-x-2 justify-center items-center bg-white/10 hover:bg-white/25 transition-all duration-400 rounded-sm p-2 lg:w-fit border border-white/20 text-sm"><img src="/github-white-icon.webp" className="w-6" />Source code</Link>
                </div>
              </div>
            </motion.div>
            <motion.div className="glass-element flex flex-col lg:flex-row items-center lg:items-stretch gap-6 lg:gap-x-6 border border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-violet-700 shadow-[0px_0px_20px_rgba(112,8,231,1)] hover:bg-violet-700/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              ...
              <div className="flex flex-col gap-y-3">
                ...
                <div className="flex gap-3 mt-auto flex-col lg:flex-row">
                  <Link href="https://modrinth.com/mod/extra-enchantments-and-curses" target="_blank" className="flex gap-x-2 justify-center items-center bg-[#1bd96a]/20 hover:bg-[#1bd96a]/35 transition-all duration-400 rounded-sm p-2 lg:w-fit border border-white/20 text-sm"><img src="/Modrinth_Logo.webp" className="w-6" />Page</Link>
                  ...
                  <Link href="https://github.com/03-JS/Extra-Enchantments-and-Curses" target="_blank" className="flex gap-x-2 justify-center items-center bg-white/10 hover:bg-white/25 transition-all duration-400 rounded-sm p-2 lg:w-fit border border-white/20 text-sm"><img src="/github-white-icon.webp" className="w-6" />GitHub</Link>
                </div>
              </div>
            </motion.div>
            <motion.div className="glass-element flex flex-col lg:flex-row items-center lg:items-stretch gap-6 lg:gap-x-6 border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-emerald-300 shadow-[0px_0px_20px_rgba(94,233,181,1)] hover:bg-emerald-300/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              ...
              <div className="flex flex-col gap-y-3">
                ...
                <div className="flex gap-3 mt-auto flex-col lg:flex-row">
                  <Link href="https://modrinth.com/resourcepack/minecraft-classic-edition" target="_blank" className="flex gap-x-2 justify-center items-center bg-[#1bd96a]/20 hover:bg-[#1bd96a]/35 transition-all duration-400 rounded-sm p-2 lg:w-fit border border-white/20 text-sm"><img src="/Modrinth_Logo.webp" className="w-6" />Resource pack page</Link>
                </div>
              </div>
            </motion.div>
            <motion.div className="glass-element flex flex-col lg:flex-row items-center lg:items-stretch gap-6 lg:gap-x-6 border border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-yellow-500 shadow-[0px_0px_20px_rgba(240,177,0,1)] hover:bg-yellow-500/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              ...
              <div className="flex flex-col gap-y-3">
                ...
                <div className="flex gap-3 mt-auto flex-col lg:flex-row">
                  <Link href="https://js03.itch.io/randoom" target="_blank" className="flex gap-x-2 justify-center items-center bg-[#FA5252]/20 hover:bg-[#FA5252]/35 transition-all duration-400 rounded-sm p-2 lg:w-fit border border-white/20 text-sm"><img src="/itchio_white_icon.webp" className="w-6" />itch.io page</Link>
                  <Link href="https://github.com/03-JS/ranDOOM" target="_blank" className="flex gap-x-2 justify-center items-center bg-white/10 hover:bg-white/25 transition-all duration-400 rounded-sm p-2 lg:w-fit border border-white/20 text-sm"><img src="/github-white-icon.webp" className="w-6" />Source code</Link>
                </div>
              </div>
            </motion.div>
          </div>
