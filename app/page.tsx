...
export default function Home() {
  return (
    <>
      <section id="home" className="flex justify-center items-center w-full 3xl:h-screen scroll-mt-24 mt-20 lg:mt-22 lg:mb-10 3xl:mb-0 3xl:mt-0 3xl:py-0">
        <div className="glass-element bg-black/70 p-0 w-[85%] max-w-6xl overflow-hidden 3xl:overflow-auto lg:max-w-[85%] h-fit flex flex-col gap-x-8 animate-fade-in-up animate-duration-1000 font-mono">
          <div className="glass-element border-t-0 border-l-0 border-r-0 rounded-br-none rounded-bl-none w-full h-fit flex justify-between p-4 relative top-0">
            <div className="flex gap-x-2 items-center justify-center">
              <span className="w-2.5 h-2.5 lg:w-3 md:h-3 rounded-full bg-[#ff6b6b]"></span>
              <span className="w-2.5 h-2.5 lg:w-3 md:h-3 rounded-full bg-[#ffd93d]"></span>
              <span className="w-2.5 h-2.5 lg:w-3 md:h-3 rounded-full bg-[#b7d86a]"></span>
            </div>
            <span className="text-xs lg:text-sm text-white/50">~/.profiles/js03</span>
          </div>
          <div className="flex flex-col w-full p-4 sm:p-6 3xl:p-10 items-start gap-x-8 font-bold animate-fade-in animate-duration-600 animate-delay-600 mb-auto text-sm 3xl:text-base">
            <p className="text-blue-500">~</p>
            <p><span className="text-purple-500">{'>'}</span> fastfetch</p>
          </div>
          <div className="flex flex-col lg:flex-row w-full p-4 sm:p-8 md:p-10 items-center lg:items-start gap-4 3xl:gap-8 animate-fade-in-up animate-duration-600 animate-delay-800">
            <img src="https://avatars.githubusercontent.com/u/107844615?v=4" className="border-2 border-white/20 rounded-2xl w-44 lg:w-54 3xl:w-64 transition-all duration-400 hover:ring-2 active:ring-2 hover:ring-(--accent-gradient-to) active:ring-(--accent-gradient-to) hover:shadow-[0px_0px_25px_var(--accent-gradient-to)] active:shadow-[0px_0px_25px_var(--accent-gradient-to)] hover:border-black active:border-black" />
            <div className="flex flex-col justify-center w-full">
              <p className="text-2xl lg:text-3xl 3xl:text-5xl font-bold text-center lg:text-left">
                Hi! I'm JS03
              </p>
              <p className="mt-3 text-white/80 text-sm 3xl:text-base">
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-4 mt-5 3xl:mt-10 items-center justify-center 3xl:justify-start">
          ...
          <div className="flex flex-col w-full p-4 sm:p-6 3xl:p-10 items-start gap-x-8 font-bold animate-fade-in animate-duration-600 animate-delay-1400 mt-auto text-sm 3xl:text-base">
            <p className="text-blue-500">~</p>
      ...
      <section id="projects" className="flex justify-center items-center w-full scroll-mt-24">
        <motion.div className="glass-element w-[85%] flex flex-col gap-y-6"
          ...
          <p className="font-bold text-2xl lg:text-3xl 3xl:text-4xl 3xl:mb-4">Projects</p>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 3xl:gap-10">
            <motion.div className="glass-element flex flex-col 3xl:flex-row items-center 3xl:items-stretch gap-6 3xl:gap-x-6 border border-white/20 rounded-xl transition-colors duration-400 ring-2 ring-cyan-500 shadow-[0px_0px_20px_rgba(0,184,219,1)] hover:bg-cyan-500/15 active:bg-cyan-500/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              <img src="/VEGA_icon.png" className="w-32 h-32 lg:max-3xl:w-40 lg:max-3xl:h-40 rounded-xl border border-white/20" />
              <div className="flex flex-col gap-y-3 lg:max-3xl:flex-1">
                ...
                <div className="flex gap-3 mt-auto flex-col 3xl:flex-row">
                  <Link href="https://thunderstore.io/c/lethal-company/p/JS03/LC_VEGA/" target="_blank" className="flex gap-x-2 justify-center items-center bg-[#14B3CB]/20 hover:bg-[#14B3CB]/35 active:bg-[#14B3CB]/35 transition-all duration-400 rounded-sm p-2 3xl:w-fit border border-white/20 text-sm"><img src="/thunderstore_icon.png" className="w-6" />Mod page</Link>
                  <Link href="https://github.com/03-JS/LC-VEGA" target="_blank" className="flex gap-x-2 justify-center items-center bg-white/10 hover:bg-white/25 active:bg-white/25 transition-all duration-400 rounded-sm p-2 3xl:w-fit border border-white/20 text-sm"><img src="/github-white-icon.webp" className="w-6" />Source code</Link>
                </div>
              </div>
            </motion.div>
            <motion.div className="glass-element flex flex-col 3xl:flex-row items-center 3xl:items-stretch gap-6 3xl:gap-x-6 border border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-pink-600 shadow-[0px_0px_20px_rgba(230,0,118,1)] hover:bg-pink-600/15 active:bg-pink-600/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              <img src="/speech_icon.png" alt="" className="w-32 h-32 lg:max-3xl:w-40 lg:max-3xl:h-40 rounded-xl" />
              <div className="flex flex-col gap-y-3 lg:max-3xl:flex-1">
                <div className="flex gap-x-[0.35rem] items-center">
                  <img src="/lethal_icon.jpg" alt="" className="w-6 h-6 rounded-sm" />
                ...
                <div className="flex gap-3 mt-auto flex-col 3xl:flex-row">
                  ...
                  <Link href="https://github.com/03-JS/SpeechRecognitionAPI" target="_blank" className="flex gap-x-2 justify-center items-center bg-white/10 hover:bg-white/25 active:bg-white/25 transition-all duration-400 rounded-sm p-2 3xl:w-fit border border-white/20 text-sm"><img src="/github-white-icon.webp" className="w-6" />Source code</Link>
                </div>
              </div>
            </motion.div>
            <motion.div className="glass-element flex flex-col 3xl:flex-row items-center 3xl:items-stretch gap-6 3xl:gap-x-6 border border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-[#ff0000] shadow-[0px_0px_20px_rgba(255,0,0,1)] hover:bg-[rgba(255,0,0,0.15)] active:bg-[rgba(255,0,0,0.15)]"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              <img src="/FNaF Rewired Icon.png" alt="" className="w-32 h-32 lg:max-3xl:w-40 lg:max-3xl:h-40 border border-white/20" />
              <div className="flex flex-col gap-y-3 lg:max-3xl:flex-1">
                <div className="flex gap-x-[0.35rem] items-center">
                ...
                <div className="flex gap-3 mt-auto flex-col 3xl:flex-row">
                  <Link href="https://gamejolt.com/games/FNaF-Rewired/1014231" target="_blank" className="flex gap-x-2 justify-center items-center bg-[#2F7F6F]/20 hover:bg-[#2F7F6F]/35 active:bg-[#2F7F6F]/35 transition-all duration-400 rounded-sm p-2 3xl:w-fit border border-white/20 text-sm"><img src="/gamejolt_icon.png" className="w-6" />Game Jolt page</Link>
                  <Link href="https://js03.itch.io/fnaf-rewired" target="_blank" className="flex gap-x-2 justify-center items-center bg-[#FA5252]/20 hover:bg-[#FA5252]/35 active:bg-[#FA5252]/35 transition-all duration-400 rounded-sm p-2 3xl:w-fit border border-white/20 text-sm"><img src="/itchio_white_icon.webp" className="w-6" />itch.io page</Link>
                </div>
              </div>
            </motion.div>
            <motion.div className="glass-element flex flex-col 3xl:flex-row items-center 3xl:items-stretch gap-6 3xl:gap-x-6 border border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-amber-500 shadow-[0px_0px_20px_rgba(254,154,0,1)] hover:bg-amber-500/15 active:bg-amber-500/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              <img src="/ultra_icon.png" alt="" className="w-32 h-32 lg:max-3xl:w-40 lg:max-3xl:h-40 rounded-xl border border-white/20" />
              <div className="flex flex-col gap-y-3 lg:max-3xl:flex-1">
                <div className="flex gap-x-[0.35rem] items-center">
                  <img src="/lethal_icon.jpg" alt="" className="w-6 h-6 rounded-sm" />
                  <span className="text-white/60 text-xs">Lethal Company mod</span>
            ...
            <motion.div className="glass-element flex flex-col 3xl:flex-row items-center 3xl:items-stretch gap-6 3xl:gap-x-6 border border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-green-500 shadow-[0px_0px_20px_rgba(0,201,80,1)] hover:bg-green-500/15 active:bg-green-500/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              <img src="/debt_icon.png" alt="" className="w-32 h-32 lg:max-3xl:w-40 lg:max-3xl:h-40 rounded-xl" />
              <div className="flex flex-col gap-y-3 lg:max-3xl:flex-1">
                <div className="flex gap-x-[0.35rem] items-center">
                  <img src="/lethal_icon.jpg" alt="" className="w-6 h-6 rounded-sm" />
                  <span className="text-white/60 text-xs">Lethal Company mod</span>
            ...
            <motion.div className="glass-element flex flex-col 3xl:flex-row items-center 3xl:items-stretch gap-6 3xl:gap-x-6 border border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-neutral-400 shadow-[0px_0px_20px_rgba(161,161,161,1)] hover:bg-neutral-400/15 active:bg-neutral-400/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              <img src="/keep_icon.png" alt="" className="w-32 h-32 lg:max-3xl:w-40 lg:max-3xl:h-40 rounded-xl border border-white/20" />
              <div className="flex flex-col gap-y-3 lg:max-3xl:flex-1">
                <div className="flex gap-x-[0.35rem] items-center">
                  <img src="/lethal_icon.jpg" alt="" className="w-6 h-6 rounded-sm" />
                  <span className="text-white/60 text-xs">Lethal Company mod</span>
            ...
            <motion.div className="glass-element flex flex-col 3xl:flex-row items-center 3xl:items-stretch gap-6 3xl:gap-x-6 border border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-violet-700 shadow-[0px_0px_20px_rgba(112,8,231,1)] hover:bg-violet-700/15 active:bg-violet-700/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              <img src="/eec_icon.png" alt="" className="w-32 h-32 lg:max-3xl:w-40 lg:max-3xl:h-40 rounded-xl border border-white/20" />
              <div className="flex flex-col gap-y-3 lg:max-3xl:flex-1">
                <div className="flex gap-x-[0.35rem] items-center">
                ...
                <div className="flex gap-3 mt-auto flex-col 3xl:flex-row">
                  <Link href="https://modrinth.com/mod/extra-enchantments-and-curses" target="_blank" className="flex gap-x-2 justify-center items-center bg-[#1bd96a]/20 hover:bg-[#1bd96a]/35 active:bg-[#1bd96a]/35 transition-all duration-400 rounded-sm p-2 3xl:w-fit border border-white/20 text-sm"><img src="/Modrinth_Logo.webp" className="w-6" />Page</Link>
                  <Link href="https://www.curseforge.com/minecraft/mc-mods/extra-enchantments-and-curses" target="_blank" className="flex gap-x-2 justify-center items-center bg-[#FF784D]/20 hover:bg-[#FF784D]/35 active:bg-[#FF784D]/35 transition-all duration-400 rounded-sm p-2 3xl:w-fit border border-white/20 text-sm"><img src="/CurseForge_icon.svg" className="w-6" />Page</Link>
                  <Link href="https://github.com/03-JS/Extra-Enchantments-and-Curses" target="_blank" className="flex gap-x-2 justify-center items-center bg-white/10 hover:bg-white/25 active:bg-white/25 transition-all duration-400 rounded-sm p-2 3xl:w-fit border border-white/20 text-sm"><img src="/github-white-icon.webp" className="w-6" />GitHub</Link>
                </div>
              </div>
            </motion.div>
            <motion.div className="glass-element flex flex-col 3xl:flex-row items-center 3xl:items-stretch gap-6 3xl:gap-x-6 border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-emerald-300 shadow-[0px_0px_20px_rgba(94,233,181,1)] hover:bg-emerald-300/15 active:bg-emerald-300/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              <img src="/mcce_icon.gif" alt="" className="w-32 h-32 lg:max-3xl:w-40 lg:max-3xl:h-40 rounded-xl border border-white/20" />
              <div className="flex flex-col gap-y-3 lg:max-3xl:flex-1">
                <div className="flex gap-x-[0.35rem] items-center">
                  <img src="/minecraft_icon.webp" alt="" className="w-5 h-5" />
                ...
                <div className="flex gap-3 mt-auto flex-col 3xl:flex-row">
                  <Link href="https://modrinth.com/resourcepack/minecraft-classic-edition" target="_blank" className="flex gap-x-2 justify-center items-center bg-[#1bd96a]/20 hover:bg-[#1bd96a]/35 active:bg-[#1bd96a]/35 transition-all duration-400 rounded-sm p-2 3xl:w-fit border border-white/20 text-sm"><img src="/Modrinth_Logo.webp" className="w-6" />Resource pack page</Link>
                </div>
              </div>
            </motion.div>
            <motion.div className="glass-element flex flex-col 3xl:flex-row items-center 3xl:items-stretch gap-6 3xl:gap-x-6 border border-white/20 w-full p-6 rounded-xl transition-colors duration-400 ring-2 ring-yellow-500 shadow-[0px_0px_20px_rgba(240,177,0,1)] hover:bg-yellow-500/15 active:bg-yellow-500/15"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.6 }}>
              <img src="/ranDOOM_icon.png" alt="" className="w-41 h-32 lg:max-3xl:w-49 lg:max-3xl:h-40 rounded-xl border border-white/20" />
              <div className="flex flex-col gap-y-3 lg:max-3xl:flex-1">
                <div className="flex gap-x-[0.35rem] items-center">
                ...
                <div className="flex gap-3 mt-auto flex-col 3xl:flex-row">
                  <Link href="https://js03.itch.io/randoom" target="_blank" className="flex gap-x-2 justify-center items-center bg-[#FA5252]/20 hover:bg-[#FA5252]/35 active:bg-[#FA5252]/35 transition-all duration-400 rounded-sm p-2 3xl:w-fit border border-white/20 text-sm"><img src="/itchio_white_icon.webp" className="w-6" />itch.io page</Link>
                  <Link href="https://github.com/03-JS/ranDOOM" target="_blank" className="flex gap-x-2 justify-center items-center bg-white/10 hover:bg-white/25 active:bg-white/25 transition-all duration-400 rounded-sm p-2 3xl:w-fit border border-white/20 text-sm"><img src="/github-white-icon.webp" className="w-6" />Source code</Link>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section id="videos" className="flex justify-center items-center w-full scroll-mt-24">
        <motion.div className="glass-element w-[85%] flex flex-col gap-y-6"
          ...
          viewport={{ once: true, amount: 0 }}
          transition={{ duration: 0.6 }}>
          <p className="font-bold text-2xl lg:text-3xl 3xl:text-4xl 3xl:mb-4 self-start">Recent videos</p>
